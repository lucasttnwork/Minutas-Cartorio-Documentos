  ...
  return (
    <div className="space-y-2">
      ...
      <FormSection title="DADOS INDIVIDUAIS" columns={3}>
        ...
        <EditableField label="Data Obito" value={pessoa.dataObito} type="date" onChange={(v) => onUpdate('dataObito', v)} wasEditedByUser={camposEditados.includes('dataObito')} />
      ...
      <FormSection title="DADOS FAMILIARES" columns={3}>
        <EditableField label="Estado Civil" value={pessoa.dadosFamiliares.estadoCivil} onChange={(v) => onUpdate('dadosFamiliares.estadoCivil', v)} wasEditedByUser={camposEditados.includes('dadosFamiliares.estadoCivil')} />
        <EditableField label="Regime de Bens" value={pessoa.dadosFamiliares.regimeBens} onChange={(v) => onUpdate('dadosFamiliares.regimeBens', v)} wasEditedByUser={camposEditados.includes('dadosFamiliares.regimeBens')} />
